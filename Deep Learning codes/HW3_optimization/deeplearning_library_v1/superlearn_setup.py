# Haoyang Han's superlearn_setup
...
class Setup:
    ...
    def fit(self,**kwargs):
        ...
        if 'beta' in kwargs:
            ...
            weight_history, cost_history = optimizers.momentum_gradient_descent(self.cost,self.alpha_choice,self.max_its,self.w_init, self.version, self.beta)
        elif 'beta' not in kwargs:
            weight_history, cost_history = optimizers.gradient_descent(self.cost,self.alpha_choice,self.max_its,self.w_init, self.version,)
        
         # store all new historieso
